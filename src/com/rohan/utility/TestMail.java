...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "R.R.alumni@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to R.R Electronics</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with R.R Electronics.<br>"
					...
					+ "<span class='greenText'>RR500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
