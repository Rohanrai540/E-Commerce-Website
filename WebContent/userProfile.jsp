...
<%@ page
	import="com.rohan.service.impl.*,com.rohan.service.*,com.rohan.beans.*,java.util.*,javax.servlet.ServletOutputStream,java.io.*"%>
<!DOCTYPE html>
<html>
<head>
...
<body style="background-color: #66dffa;">
	...
	if (user == null)
		user = new UserBean("Test User", 1234567890L, "test@gmail.com", "ABC colony, Vaishali, Ghaziabad", 87659, "lksdjf");
	%>
